    ...
    <body>
        ...
        <div id="index-container">
          <div id="table-header" align="center">
            ...
            <form action="includes/entity-posts.inc.php" method="post">
                <div class="input-group">
                    <p id="textHeader">Let the donors know your cause:</p>

                    <input class="input-group" type="text" name="posts" placeholder="Post something...">
                    <br>
